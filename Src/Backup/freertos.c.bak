...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the timer(s) */
  /* definition and creation of ALGO_TIM */
  osTimerDef(ALGO_TIM, Callback_ALGO_TIM);
  ALGO_TIMHandle = osTimerCreate(osTimer(ALGO_TIM), osTimerPeriodic, NULL);
...
void Callback_ALGO_TIM(void const * argument)
{
  /* USER CODE BEGIN Callback_ALGO_TIM */
   Lib_ReadRequest();
  /* USER CODE END Callback_ALGO_TIM */
}
